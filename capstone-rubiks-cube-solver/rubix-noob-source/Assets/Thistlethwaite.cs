...
using System;
using System.Linq;
//Code adapted from Andy Shih's "Rubik" Solver.cs
//https://github.com/ashih42/Rubik
public class Thistlethwaite
{
	...
	public List<String> Solve(Cube cube)
	{
		...
		while (++phase < 5)
		{
			...
			foreach (int moveInt in moveInts)
			{
				...
				String move = this.createMoveFromInt(moveInt);
				moveList.Add(move);
	...
	public String createMoveFromInt(int move)
	{
		switch (move)
		{
			case 0:
	...
	public void moveCube(Cube cube)
	{
		foreach (String move in moveList)
		{
			...
			{
				case "U":
					cube.rotateWhite(Direction.CLOCKWISE);
					break;
				case "U2":
					cube.rotateWhite(Direction.CLOCKWISE);
					cube.rotateWhite(Direction.CLOCKWISE);
